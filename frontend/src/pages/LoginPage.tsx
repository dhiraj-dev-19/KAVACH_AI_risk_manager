    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 bg-slate-900/90 border border-slate-800 p-8 rounded-2xl shadow-xl backdrop-blur">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-slate-100 tracking-tight">Sign in to JUDGE</h2>
          <p className="text-xs text-slate-400">AI Risk Manager & Fraud Detection Platform</p>
        </div>
        ...
        <div className="pt-4 border-t border-slate-800/80 text-center">
          <p className="text-xs text-slate-400">
            ...
            <Link to="/signup" className="text-blue-400 font-semibold hover:text-blue-300 hover:underline transition">
              Create an account
            </Link>
          </p>
        </div>
